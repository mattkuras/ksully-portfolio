    ...
    return<div className="product-container">
       {productList.map((product) => (
         <div key={product.name} className="product">
           <img src="https://images.unsplash.com/photo-1519681393784-d120267933ba?ixid=MXwxMjA3fDB8MHxzZWFyY2h8OXx8bW91bnRhaW5zfGVufDB8fDB8&ixlib=rb-1.2.1&w=1000&q=80"/>
           <h1>{product.name}</h1>
